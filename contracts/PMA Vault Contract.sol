...
/// @title PMAVault - Contract that will hold PMA locked for a specific period of time with predefined withdawal windows for a certain percentage of tokens.
/// @author Giorgos Kourtellos - <giorgos@pumapay.io>
contract PMAVault is Ownable {
